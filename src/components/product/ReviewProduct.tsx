...
const ReviewProduct = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="relative max-w-md rounded-none p-6">
        {/* Close */}
        <button
        ...
        <div className="mt-6 space-y-6">
          ...
          {/* Review */}
          <div className="space-y-2">
            <p className="text-sm font-light">Your review</p>
            <Textarea
              value={review}
              onChange={(e) => setReview(e.target.value)}
              placeholder="Share your thoughts about this product..."
              className="min-h-28 resize-none rounded-none font-light"
            />
          </div>
          ...
          <Button
            ...
            className="h-12 w-full rounded-none bg-foreground font-light text-background hover:bg-foreground/90"
          >
            Submit review
          </Button>
        </div>
