...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Aureeka Jewels";
  }, []);
          ...
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="leading-relaxed">
                By accessing and using the Aureeka Jewels website and services, you accept and agree to be
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                of Aureeka Jewels and is protected by intellectual property laws. Unauthorized use is prohibited.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 bg-cream-50 rounded-xl p-4">
                <p>Email: legal@aureekajewels.com</p>
                <p>Phone: +91 9179518505</p>
              </div>
            </section>
          </div>
        </div>
