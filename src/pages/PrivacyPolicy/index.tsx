...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy - Aureeka Jewels";
  }, []);
          ...
          <div className="space-y-8 text-muted-foreground">
            <section>
              ...
              <p className="leading-relaxed">
                At Aureeka Jewels, we respect your privacy and are committed to protecting your personal data.
            ...
            <section>
              ...
              <div className="mt-4 bg-cream-50 rounded-xl p-4">
                <p>Email: privacy@aureekajewels.com</p>
