...
class AppConstants {
  static const String appName = 'Aureeka Jewels';
  static const String slogan = '';
  static const String appVersion = '15.3';

  ///Flutter SDK 3.32.6
  static const LocalCachesTypeEnum cachesType = LocalCachesTypeEnum.all;

  static const String baseUrl = 'https://aureekajewels.com/aj';

  static const String productVideoUri = '/api/v1/products/videos';
